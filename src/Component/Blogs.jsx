    ...
    return (
        <div>
            <div tabIndex={0} className="collapse group">
                <div className="collapse-title text-3xl font-bold bg-accent opacity-90 text-white">
            ...
            <div tabIndex={2} className="collapse group">
                <div className="collapse-title text-3xl font-bold bg-success opacity-50 text-white">
            ...
            <div tabIndex={3} className="collapse group">
                <div className="collapse-title text-3xl font-bold bg-base-300 opacity-50 text-white">
